...
### `Current Version: v1.4.6` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.4.6 릴리즈 🚀
- **✨ 관리자 UX 편의성 강화**: 모든 모달의 배경 클릭 시 닫기 지원, 악보 전체보기 모드에서 '화면 맞춤'과 '원본 크기' 사이의 클릭 토글(Zoom) 기능 추가
- **✨ 악보 전체보기(확대) 기능 추가**: 관리자 페이지 내의 썸네일이나 미리보기 이미지 클릭 시 확대 팝업 지원
