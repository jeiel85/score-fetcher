...
### `Current Version: v1.4.3` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.4.3 릴리즈 🚀
- **🐛 악보 미리보기 로드 버그 수정**: 곡 번호 숫자에 따른 3자리 패딩(007.png 등) 및 다양한 확장자(.png, .jpg 등)를 순차적으로 시도하도록 이미지 로드 로직 최적화
- **✨ 가사 신고 관리 UX 혁신**: 관리자 페이지에서 곡 제목 확인, 썸네일 미리보기, 제목/가사 동시 수정 기능 추가
