...
### `Current Version: v1.4.1` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.4.1 릴리즈 🚀
- **✨ 가사 신고 관리 고도화**: 관리자 페이지에서 신고된 곡의 가사를 즉시 확인 및 수정하고, 완료 처리(`completed`)할 수 있는 통합 워크플로우 구축
- **✨ 가사 신고 기능 전면 복구**: 수동 보안 규칙 적용과 함께 UI/로직 재활성화 완료
