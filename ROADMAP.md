...
### `Current Version: v1.3.5` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.3.5 릴리즈 🚀
- **🛡️ 가사 신고 전송 안정화**: `fetch` API 대신 Firebase SDK(`database().ref().push()`)를 직접 사용하여 토큰 인증 및 전송 실패 문제 원천 차단
- **🐛 가사 신고 기능 수정**: 인증 토큰 누락으로 인한 401/403 에러 해결 완료
