...
### `Current Version: v1.4.5` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.4.5 릴리즈 🚀
- **✨ 악보 전체보기(확대) 기능 추가**: 관리자 페이지 내의 썸네일이나 가사 수정 모달의 미리보기 이미지를 클릭하면 화면 가득 채워서 볼 수 있는 줌 모달 구현
- **✨ 가사 수정 모달 UI 최적화**: 모달 높이 고정 및 가로 2단 구성으로 악보/텍스트 동시 작업 환경 개선
