...
### `Current Version: v1.4.9` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.4.9 릴리즈 🚀
- **✨ 악보 확대 모달 구조 전면 개편**: 배경(Bg)과 콘텐츠를 분리하여 클릭 간섭을 완전히 제거하고, 원본 크기 확대 시에도 X 버튼이 항상 최상단에 고정되도록 개선
- **🐛 배경 스크롤 방지 로직**: 모달 활성화 시 메인 화면의 스크롤을 일시 정지하여 조작 편의성 향상
