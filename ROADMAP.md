...
### `Current Version: v1.4.8` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.4.8 릴리즈 🚀
- **🐛 악보 확대 배경 클릭 닫기 수정**: 이미지 클릭 시 상위 요소로의 이벤트 전파를 차단하여, 배경 클릭 시에만 확실하게 모달이 닫히도록 로직 정교화
- **🐛 악보 확대 중앙 정렬 최적화**: 원본 크기로 확대 시 이미지가 좌측에 쏠리던 현상 수정
