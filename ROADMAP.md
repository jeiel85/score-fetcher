...
### `Current Version: v1.5.1` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.5.1 릴리즈 🚀
- **🐛 악보 확대 시 닫기 불능 버그 수정**: 원본 크기(.original) 클래스가 활성화(.active) 클래스 없이도 모달을 표시하던 CSS 종속성 오류 해결 및 닫기 시 모든 상태 초기화 로직 보강
- **🏁 악보 확대 모달 최종 완성**: 이벤트 전파 차단 및 레이어 독립성 강화
