...
### `Current Version: v1.3.9` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.3.9 릴리즈 🚀
- **🛑 가사 신고 기능 잠정 중단**: Firebase 서버 측 보안 규칙 미적용 문제로 인해 지속적인 권한 오류 발생. 사용자 피로도 감소를 위해 UI에서 관련 버튼 제거 및 로직 비활성화
- **🚨 가사 신고 권한 긴급 수정**: (이전 시도) Permission Denied 해결을 위한 보안 규칙 완화 시도
