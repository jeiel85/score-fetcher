...
### `Current Version: v1.5.5` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.5.5 릴리즈 🚀
- **✨ 가로 모드 버전 정보 가독성 보정**: 폰트 크기 확대(13px), 불투명도 조절(0.85) 및 상단 버튼군과의 우측 정렬(padding: 16px) 보충
- **🍎 가로 모드 UX 최적화 (v1.5.4)**: 전문가 피드백을 반영하여 앵커형 버전 정보 배치로 레이어 균형 확보
