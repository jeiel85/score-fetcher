...
### `Current Version: v1.4.7` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.4.7 릴리즈 🚀
- **🐛 악보 확대 중앙 정렬 최적화**: 원본 크기로 확대 시 이미지가 좌측에 쏠리던 현상을 수정하여, 스크롤 가능한 상태에서도 항상 수평 중앙에 위치하도록 레이아웃 보강
- **✨ 관리자 UX 편의성 강화**: 모든 모달의 배경 클릭 시 닫기 지원, 악보 전체보기 모드에서 줌 토글 기능 추가
