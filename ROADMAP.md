...
### `Current Version: v1.5.2` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.5.2 릴리즈 🚀
- **✨ 가로/세로 모드 UI 리밸런싱**: 태블릿 가로 모드 네비게이션 버튼 확대(28px), 헤더 폰트 조정 및 세로 모드 곡 제목 가독성 개선
- **🐛 화면 회전 시 리스트 증발 버그 수정**: 가로에서 세로로 화면 회전 시 악보 리스트가 렌더링되지 않던 상태 불일치 문제 해결
