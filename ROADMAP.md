...
### `Current Version: v1.3.0` (2026.03.26)

> 최종 목표: 웹 PWA → Capacitor 기반 Android / iOS 네이티브 앱 출시

---

## 현재 상태 (2026-03-26 기준, 최종 업데이트: 11:30)
...
## 최근 작업 이력 (2026-03-26) / v1.3.0 릴리즈 🚀
- **🔐 Github 토큰 클라우드 동기화**: AES-256 암호화 기반 기기 간 자동 동기화 구축
- **🐛 가사 신고 에러 수정**: Firebase 보안 규칙 업데이트로 신고 데이터 정상 적재 확인 
- **🎨 퀵 네비게이션 UX 개선**: 곡 목록에서 퀵 이동 버튼 표시 시 가사 버튼과 탭 영역이 겹치지 않도록 동적 패딩(42px) 적용
- **🏷️ 버전업**: `v1.2.1` -> `v1.3.0` 상향 및 강제 업데이트 배포
