...
### `Current Version: v1.4.0` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.4.0 릴리즈 🚀
- **✨ 가사 신고 기능 전면 복구**: 수동 보안 규칙 적용 가이드와 함께 UI/로직 재활성화 완료
- **🛑 가사 신고 기능 잠정 중단**: (이전 시도) 서버 권한 이슈로 인해 일시적 제거
