...
### `Current Version: v1.5.0` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.5.0 릴리즈 🚀
- **🏁 악보 확대 모달 최종 완성**: 이벤트 전파(stopPropagation)를 철저히 차단하여 하위 레이어 간섭 문제를 완벽히 해결하고, X 버튼의 절대적 레이어 우선순서 확보 (v1.5 마일스톤)
- **✨ 악보 확대 모달 구조 전면 개편**: 배경 클릭 시 오동작 해결 및 독립형 UI 구조 확립
