...
### `Current Version: v1.3.4` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.3.4 릴리즈 🚀
- **🐛 가사 신고 기능 최종 수정**: 데이터를 서버로 전송할 때 Firebase 인증 토큰(`auth`)이 누락되어 발생하던 쓰기 권한 오류 해결
- **🎨 푸터 레이아웃 최적화**: 앱 하단 GitHub 링크와 버전 배지 중앙 정렬 완료
