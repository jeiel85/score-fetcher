...
### `Current Version: v1.5.3` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.5.3 릴리즈 🚀
- **✨ 가로 모드 푸터 UI 표시**: 가로(태블릿) 모드에서도 Github 아이콘 및 버전 정보가 우측 하단에 슬림하게 노출되도록 개선
- **✨ 가로/세로 모드 UI 리밸런싱**: 태블릿 가로 모드 네비게이션 버튼 확대 등 전반적 품질 향상
