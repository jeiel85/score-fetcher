...
### `Current Version: v1.3.3` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.3.3 릴리즈 🚀
- **🎨 푸터 레이아웃 최적화**: 앱 하단에 쏠려 있던 GitHub 링크와 버전 배지를 중앙으로 정렬하여 시각적 안정성 확보
- **✨ 퀵 내비게이션 스크롤 동기화**: 노래 목록 스크롤 시 현재 인덱스 도트 자동 하이라이트 기능 고도화
