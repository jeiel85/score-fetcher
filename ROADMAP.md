...
### `Current Version: v1.3.8` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.3.8 릴리즈 🚀
- **🚨 가사 신고 권한 긴급 수정**: `Permission Denied` 해결을 위해 `reports` 노드의 쓰기 권한을 일시적으로 전면 허용하고 인증 예외 처리 강화
- **🛡️ 권한 오류(Permission Denied) 수정**: 가사 신고 시 인증 상태 체크 로직 보강
