...
### `Current Version: v1.5.4` (2026.03.26)
...
## 최근 작업 이력 (2026-03-26) / v1.5.4 릴리즈 🚀
- **🍎 가로 모드 UX 최적화**: 전문가 피드백을 반영하여 글로벌 푸터를 제거하고, 버전 정보를 우측 하단 컨셉 버튼 영역(panel-bottom)으로 앵커링하여 시각적 균형 확보
- **✨ 가로 모드 푸터 가시성 개선 (v1.5.3)**: 가로 모드에서도 Github 아이콘 및 정보 확인 가능
